...
This repository is the **home of the ImmPrint collection**, holding the data, 
the curation rationale and the project website. ImmPrint is a focused collection of
...
Transducer, Effector hierarchy and tied to a paper that links each gene to its 
pathway.
