...
[Download CSV](data/immprint_0.3.0-alpha.csv){.btn-ghost download="immprint_0.3.0-alpha.csv"}
[Download JSON](data/immprint_0.3.0-alpha.json){.btn-ghost download="immprint_0.3.0-alpha.json"}
...
url = "https://akmclz.github.io/immprint/data/immprint_0.3.0-alpha.csv"
ip = pd.read_csv(url)
...
`immprintr(version = "0.3.0-alpha")` and the raw files are version-stamped, so
